...
- `qd_mnp_calculate_work_loss_spectrum_material_comparison.py` — расчёт;
- `qd_mnp_plot_work_loss_spectrum_material_comparison.py` — построение.
...
```powershell
.\.venv\Scripts\python.exe -m article_observables.qd_mnp_calculate_work_loss_spectrum_material_comparison --preset quick --channel axis_long --fluence-j-cm2 1e-8 1e-6 1e-5 --fluence-label linear threshold nonlinear --output results/quick/work_loss_spectrum_material_comparison.npz
.\.venv\Scripts\python.exe -m article_observables.qd_mnp_plot_work_loss_spectrum_material_comparison results/quick/work_loss_spectrum_material_comparison.npz --allow-unconverged --output results/quick/work_loss_spectrum_material_comparison.png
```

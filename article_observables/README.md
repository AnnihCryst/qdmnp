...
Это спектральное дополнение к зависимости при фиксированной энергии из
раздела 2 и прямой аналог импульсного оптического наблюдаемого у Shah. Один
...
`N=1` здесь означает намеренно грубую однополюсную аппроксимацию той же

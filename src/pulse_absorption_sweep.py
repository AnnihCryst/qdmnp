...
Скрипт решает временную задачу из ``qdmnp.rational_fit.py`` для сетки
...
``qdmnp.linear_spectrum.py``. Физические параметры настраиваются аргументами
...
def save_artifact_run(
    *,
    ...
    metadata = {
        "schema_version": SCHEMA_VERSION,
        "script": "qdmnp.pulse_absorption_sweep.py",

...
скриптов ``qdmnp.linear_spectrum.py``, ``qd_mnp_fano_scan.py`` и
``qdmnp.pulse_absorption_sweep.py``. При прямом запуске файл выполняет
...
from qdmnp.passive_fit import PassiveFitRefinement, positive_lorentz_candidate

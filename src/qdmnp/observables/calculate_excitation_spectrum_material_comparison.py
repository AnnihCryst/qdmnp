...
from qdmnp.observables.spectral_features import extract_feature, sampling_diagnostics
from qdmnp.observables.calculate_excitation_fluence import (
    HYBRID_CHANNELS,
    ChannelSpec,
)
from qdmnp.observables.material_modes_artifact import (
    atomic_write_npz,
    canonical_sha256,
    git_provenance,
    source_hashes,
    ...
    *,
    ...
    metadata: dict[str, Any] = {
        ...
        "model_api": {
            ...
            "linear_hybrid": "qdmnp.spheroid_green.solve_linear_hybrid_response",
            "isolated_QD": "qdmnp.spheroid_green.qd_linear_polarizability_from_params",
        },
        ...
        "provenance": {
            ...
            "source_sha256": source_hashes(
                (
                    generator,
                    Path(__file__),
                    PACKAGE_ROOT / "observables" / "material_modes_artifact.py",

...
``plot_material_dispersion_comparison.py`` program for styling.
"""
...
def calculate_material_dispersion_comparison(
    ...
    helper_path = PACKAGE_ROOT / "observables" / "material_modes_artifact.py"
    model_path = PACKAGE_ROOT / "rational_fit.py"

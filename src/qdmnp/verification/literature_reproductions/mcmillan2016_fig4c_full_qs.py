...
# ``python -m qdmnp.verification.literature_reproductions.mcmillan2016_fig4c_full_qs`` and
# ``python qdmnp.verification.literature_reproductions/mcmillan2016_fig4c_full_qs.py``.

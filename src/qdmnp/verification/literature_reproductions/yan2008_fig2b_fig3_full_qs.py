...
# Keep both ``python -m qdmnp.verification.literature_reproductions...`` and direct execution of
...
from qdmnp.linear_spectrum import quasistatic_work_loss_cross_section_cm2
